...
export default function Login() {
  ...
  function loginHandler() {
    axios
      .post(LoginRoute, { email, password }, { withCredentials: true })
      .then((Response) => {
          ...
          <div>
            <div className="form-container">
              <form autoComplete="off">
                ...
                {!message.isAuth && (
                  <span className="result_message">{message.message}</span>
                )}
              ...
              <a href="/" className="forgotten_password">
                Forgotten Password?
              </a>

              <hr className="hr_line" />
              <button className="register_link" onClick={registerHandler}>
                Create New Account
              </button>
            </div>
            <div className="create_page">
              <Link href={"/pageRegister"}>Create a Page</Link> for a
              celebrity,brand,business
            </div>
          </div>
        </div>
      </div>
